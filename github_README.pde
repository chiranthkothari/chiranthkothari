...
void setup() {
  ...
  strs[0][0] = "Hey there!";
  strs[0][1] = "My name is Chiranth Jain";

  strs[1][0] = "I'm a Front-end developer";
  strs[1][1] = "I'm currently learning Backend development (NodeJS)";

  strs[2][0] = "I've been teaching myself how to code for 6 years!";
  strs[2][1] = "I am fluent in Javascript, Dart, HTML & CSS.";

  strs[3][0] = "Currently running on Windows 11";
  strs[3][1] = "Tools and frameworks: VS Code, ReactJS, Flutter, Firebase & NodeJS";

  strs[5][0] = "Feel free to reach out to say hi!";
  strs[5][1] = "email: chiranthkothari96@gmail.com";
}
